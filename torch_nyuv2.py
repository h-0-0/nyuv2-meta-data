...
# I have edited it slightly so that it returns the RGB image, the depth image and the segmentation mask in that order,
# I've also added support for 40 classes segmentation masks.
